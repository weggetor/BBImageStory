...
namespace DNNtc
{
    ...
    /// <summary>
    /// <para>This class is used to set information about the package.</para>
    /// <para>PackageProperties(PackageName, ViewOrder, PackageFriendlyName, PackageDescription, Iconfile, OwnerName, OwnerOrganization, OwnerUrl,OwnerEmail, AzureCompatible)</para>
    /// </summary>
    ...
    /// <summary>
    /// <para>This class is used to set information about the module.</para>
    /// <para>ModuleProperties(ModuleName, string ModuleFriendlyName, DefaultCacheTime)</para>
    /// </summary>
    [AttributeUsage(AttributeTargets.Class, AllowMultiple = true)]
    ...
    /// <summary>
    /// <para>This class is used to indicate which UserControls should be in the install package</para>
    /// <para>ModuleControlProperties(Key, Title, ControlType, HelpUrl, SupportsPartialRendering = false, SupportsPopUps = false)</para>
    /// </summary>
